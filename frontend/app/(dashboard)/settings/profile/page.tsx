...
export default function ProfilePage() {
  ...
  return (
    // إزالة max-w-3xl واستبدالها بـ max-w-7xl أو w-full لاستغلال عرض الشاشة
    <div className="space-y-8 w-full max-w-7xl animate-fade-in pb-10" dir="rtl">
      ...
      {/* ── Grid Container للحفاظ على التوافق مع كل الشاشات ── */}
          ...
          <CardContent className="pt-6 space-y-6">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
              ...
              <div className="space-y-2">
                ...
                <div className="h-12 px-4 rounded-xl border border-slate-200 bg-slate-50/50 flex items-center text-sm font-bold text-slate-900 select-none overflow-hidden text-ellipsis" dir="ltr">
                  {merchant?.email}
                </div>
              </div>
          ...
          <CardContent className="pt-6 space-y-5">
            ...
            <div className="pt-2">
              <Button 
                ...
                disabled={submitting} 
                className="h-12 px-8 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white font-bold shadow-lg shadow-indigo-600/20 w-full transition-all"
              >
