...
// رفع الحد العام لضمان استقرار التيست وتطوير الـ Zameny Engine
...
// ✅ المسار الأساسي (لحل مشكلة 404 على منصة Render وتأكيد عمل السيرفر)
app.get('/', (req, res) => {
  res.status(200).json({ 
    status: 'success',
    message: 'Zameny Commerce API is running smoothly! 🚀' 
  });
});
...
app.get('/health', (req, res) => {
  res.status(200).json({
    status:    'OK',
    platform:  'Zameny Commerce Engine',
    version:   '2.0.0',
